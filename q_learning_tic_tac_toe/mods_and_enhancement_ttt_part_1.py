...
'''
trained dict vs summer 2023 game logic.
thinking of providing some configuration file so, that the Neural Network class is able to read it and leverage the features.
here.

just a thought, leave the tictactoe part TrainingTicTacToe training intact. 
Create another class called mods that inherits TrainingTicTacToe, and applies the modifications,
pass the right configurations to so that the game runs with the appropriate configuration.

configuration: {
    'trained_dict_vs_summer_2023': 
}
'''
