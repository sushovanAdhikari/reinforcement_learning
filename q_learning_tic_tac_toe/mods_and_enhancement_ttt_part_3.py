...
'''
X is the trained dict and X's first move is random.
'''
...
class TrainTicTacToe(TicTacToe):
    ...
    def print_info(self):
        ...
        print(f'win X total:{self.game_win_count["X"]} || win O total:{self.game_win_count["O"]} || win D total:{self.game_win_count["D"]}')
